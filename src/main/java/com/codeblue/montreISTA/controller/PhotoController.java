...
public class PhotoController {
    ...
    public ResponseEntity<Object> findAllPhoto(){
        try {
            List<PhotoResponseDTO> results = photoServices.findAll();
    ...
    public ResponseEntity<Object> findByname(@Param("keyword") String keyword){
        try{
        List<PhotoResponseDTO> results = photoServices.findByUsername(keyword);
            return ResponseHandler.generateResponse("successfully retrieved products", HttpStatus.OK, results);
        }catch (Exception e){
            return ResponseHandler.generateResponse(e.getMessage(), HttpStatus.NOT_FOUND, null);
        }
    ...
    public ResponseEntity<Object> findByPhotoName(@Param("keyword") String keyword){
        try {
            List<PhotoResponseDTO> results = photoServices.findByPhotoName(keyword);
            return ResponseHandler.generateResponse("successfully retrieved products", HttpStatus.OK, results);
        }catch (Exception e){
            return ResponseHandler.generateResponse(e.getMessage(), HttpStatus.NOT_FOUND, null);
        }
    ...
    public ResponseEntity<Object> findByProductname(@Param("keyword") String keyword){
        try{
        List<PhotoResponseDTO> results = photoServices.findByProductName(keyword);
            return ResponseHandler.generateResponse("successfully retrieved products", HttpStatus.OK, results);
        }catch (Exception e){
            return ResponseHandler.generateResponse(e.getMessage(), HttpStatus.NOT_FOUND, null);
        }
    ...
    public ResponseEntity<Object> postPhoto(@RequestBody PhotoRequestDTO photo) {
        try {
            PhotoPostDTO results = photoServices.createPhoto(photo);
    ...
    try{
        PhotoResponseDTO results = photoServices.updatePhoto(photo,id);
